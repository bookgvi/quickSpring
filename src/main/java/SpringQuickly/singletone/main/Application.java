...
//        IService mailService = ctx.getBean(MailServiceImpl.class);
        ...
        logger.info("PushServiceBean1:\n\t" + pushServiceSingle1.getClass().getSimpleName());
        logger.info("PushServiceBean2:\n\t" + pushServiceSingle1.getClass().getName());
        logger.info("pushServiceSingletoneScope1:\n\t" + pushServiceSingletoneScope1.getClass().getName());
        logger.info("pushServiceSingletoneScope2:\n\t" + pushServiceSingletoneScope2.getClass().getName());
